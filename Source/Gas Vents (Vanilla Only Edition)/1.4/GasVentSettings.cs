...
public class GasVentSettings : ModSettings
{
    ...
    private void DrawGasAmount(Listing_Standard listingStandard)
    {
        ...
        string gasAmountTooltip = "GasVents.Settings.GasAmount.Tooltip".Translate(defaultGasAmount);
    ...
    private void DrawFuelConsumptionRate(Listing_Standard listingStandard)
    {
        ...
        string fuelConsumptionRateTooltip = "GasVents.Settings.FuelConsumptionRate.Tooltip".Translate(defaultFuelConsumptionRate.ToString("F2"));
